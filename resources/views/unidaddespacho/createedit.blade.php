...
<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        <h3 align="center">Nuevo Unidad Despacho</h3>
        @else
        ...
        @endif
        <br>
        <form id="formulario" autocomplete="off" method="POST" enctype="multipart/form-data" action="{{ url('sisadmin/unidaddespacho/store') }}">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="panel-uno" role="tabpanel" aria-labelledby="uno-tab">
                    ...
                    <div class="row justify-content-center" style="margin-top: 30px;">
                        ...
                        <a class="btn btn-danger" href="{{ url('sisadmin/unidaddespacho/')}}">Cancelar</a>
                    </div>
                    @endif
                </div>
                <div class="tab-pane fade" id="panel-dos" role="tabpanel" aria-labelledby="dos-tab">
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-4">
                            @if ($unidadDespacho->und_id == 0)
                            <label class="col-md-12 col-form-label text-right">Nuevo Organigrama*:</label>
                            <div class="form-group row">
                            ...
                            <br><br><br><br>
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">Archivo Actual:</label>
                                <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <p class="form-text text-danger">{{ $message }}</p>
                                    @enderror
                                    <p style="font-size:12px">La imagen no puede ser mayor a 1740 x 550 pixeles y debe de ser en formato jpg o jpeg menor a 2Mb </p>
                                </div>
                            </div>
                            @if ($unidadDespacho->und_id == 0)
                            @else
