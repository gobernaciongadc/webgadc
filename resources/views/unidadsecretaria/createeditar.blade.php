...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @else
                <h3 align="center">Editar la {{$unidad->nombre}}</h3>
            @endif
            @if ($unidadSecretaria->und_id == 0)
            ...
            @endif
            <br>
            <form id="formulario" autocomplete="off" method="POST" enctype="multipart/form-data" action="{{ url('sisadmin/unidadsecretaria/storeeditar') }}">
                        ...
                        <div class="col-md-12 row"><br><br>
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="2" cols="40" type="text"  class="form-control form-control-sm" name="historia" id="historia" required >{{ old('historia',$unidadSecretaria->historia) }}</textarea>
                                        @error('historia')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
