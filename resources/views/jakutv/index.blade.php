            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span id="card_title">
                            {{ __('Gestión Categoria Jaku') }}
                        </span>
                        <a href="{{ route('gestionjakutv.index') }}" class="btn btn-sm btn-primary">Gestión archivos digitales Jaku</a>
                        <div class="float-right">
                            <a href="{{ route('jakutv.create') }}" class="btn btn-primary btn-sm float-right" data-placement="left">
                                {{ __('Crear nueva tarjeta Jaku') }}
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="semanario" class="table table-striped table-hover" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('jakutv.edit', $gobernaciontv) }}" class="btn btn-sm btn-primary">Editar</a>
                                        <!-- Botón para eliminar -->
                                        <form action="{{ route('jakutv.destroy', $gobernaciontv) }}" method="POST" style="display: inline;"> <!-- Cambiado a gobernaciontv -->
                                            @csrf
                                            @method('DELETE')
