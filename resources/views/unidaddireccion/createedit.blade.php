...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Organización / Direccion</li>
        </ol>
    </nav>
    <!-- Breadcrumb Area End-->
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if ($unidadDireccion->und_id == 0)
                <h3 align="center">Nuevo Direccion</h3>
            @else
                <h3 align="center">Editar Direccion</h3>
            @endif
            @if ($unidadDireccion->und_id == 0)
            ...
            @endif
            <br>
            <form id="formulario" autocomplete="off" method="POST" enctype="multipart/form-data" action="{{ url('sisadmin/unidaddireccion/store') }}">
                    ...
                    <div class="tab-pane fade" id="panel-uno" role="tabpanel" aria-labelledby="uno-tab">
                        <div class="col-md-12 row"><br><br>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        {{
                                             Form::select('bio_id',$listaBiografias, $unidadDireccion->bio_id,  ['class' => 'form-control form-control-sm','id' => 'bio_id','style' => 'width:100%;' ,'name'=>'bio_id'])
                                        }}
                                    </div>
                                    @error('bio_id')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        {{
                                             Form::select('und_padre_id',$listaComboUnidades, $unidadDireccion->und_padre_id,  ['class' => 'form-control form-control-sm','id' => 'und_padre_id','style' => 'width:100%;' ,'name'=>'und_padre_id','require'=>'require'])
                                        }}
                                    </div>
                                    @error('und_id')
                                    <p class="form-text text-danger">{{ $message }}</p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        {{Form::hidden('und_id',$unidadDireccion->und_id)}}
                                        {{Form::hidden('estado',$unidadDireccion->estado)}}


                                        <input type="text" value="{{ old('nombre',$unidadDireccion->nombre) }}" class="form-control form-control-sm"  name="nombre" id="nombre" required >
                                        @error('nombre')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="2" cols="40" type="text"  class="form-control form-control-sm" name="mision" id="mision">{{ old('mision',$unidadDireccion->mision) }}</textarea>
                                        @error('mision')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="2" cols="40" type="text"  class="form-control form-control-sm" name="vision" id="vision">{{ old('vision',$unidadDireccion->vision) }}</textarea>
                                        @error('vision')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="2" cols="40" type="text"  class="form-control form-control-sm" name="objetivo" id="objetivo" required >{{ old('objetivo',$unidadDireccion->objetivo) }}</textarea>
                                        @error('objetivo')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="2" cols="40" type="text"  class="form-control form-control-sm" name="historia" id="historia" required >{{ old('historia',$unidadDireccion->historia) }}</textarea>
                                        @error('historia')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text"   value="{{ old('telefonos',$unidadDireccion->telefonos) }}" class="form-control form-control-sm"  name="telefonos" id="telefonos">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-right">Celular(Whats App):</label>
                                    <div class="col-md-8">
                                        <input type="text" maxlength="10" value="{{ old('celular_wp',$unidadDireccion->celular_wp) }}" class="form-control form-control-sm"  name="celular_wp" id="celular_wp"  >
                                        @error('celular_wp')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email"  value="{{ old('email',$unidadDireccion->email) }}" class="form-control form-control-sm"  name="email" id="email" >
                                        @error('email')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text"  value="{{ old('link_facebook',$unidadDireccion->link_facebook)}}" class="form-control form-control-sm"  name="link_facebook" id="link_facebook" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-right">Link twiter:</label>
                                    <div class="col-md-8">
                                        <input type="text"  value="{{ old('link_twiter',$unidadDireccion->link_twiter)}}" class="form-control form-control-sm"  name="link_twiter" id="link_twiter" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-right">Link instagram:</label>
                                    <div class="col-md-8">
                                        <input type="text"  value="{{ old('link_instagram',$unidadDireccion->link_instagram)}}" class="form-control form-control-sm"  name="link_instagram" id="link_instagram" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-right">Link youtube:</label>
                                    <div class="col-md-8">
                                        <input type="text"  value="{{ old('link_youtube',$unidadDireccion->link_youtube)}}" class="form-control form-control-sm"  name="link_youtube" id="link_youtube" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="{{ old('lugar',$unidadDireccion->lugar)}}" class="form-control form-control-sm"  name="lugar" id="lugar" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-right">Direccion:</label>
                                    <div class="col-md-8">
                                        <input type="text" value="{{ old('direccion',$unidadDireccion->direccion)}}" class="form-control form-control-sm"  name="direccion" id="direccion" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label id="latitudVista" class="col-form-label text-right">Latitud: {{$unidadDireccion->latitud}}</label>
                                    </div>
                                    <div class="col-md-3">
                                        <label id="longitudVista" class="col-form-label text-right">Longitud: {{$unidadDireccion->longitud}}</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="hidden"  value="{{$unidadDireccion->latitud}}" name="latitud" id="latitud">
                                        <input type="hidden"  value="{{$unidadDireccion->longitud}}"  name="longitud" id="longitud">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @else
                            <div class="row justify-content-center" style="margin-top: 30px;">
                                ...
                                <a class="btn btn-danger" href="{{ url('sisadmin/unidaddireccion/')}}">Cancelar</a>
                                <input type="hidden" value="{{ old('tiu_id',$unidadDireccion->tipoUnidad->tiu_id) }}" name="tiu_id" id="tiu_id">
                            </div>
                        @endif
                    </div>
                    <div class="tab-pane fade" id="panel-dos" role="tabpanel" aria-labelledby="dos-tab">
                        <div class="col-md-12 row">
                            <div class="col-md-4">
                                ...
                                @else
                                    {{
                                          Html::image(asset('storage/uploads/'.$unidadDireccion->imagen_icono), 'Sin Imagen', array('id'=>'imagen_icono', 'class' =>'img-thumbnail','width'=>'200'))
                                    }}
                            ...
                            <div class="col-md-4">
                                ...
                                @else
                                    {{
                                          Html::image(asset('storage/uploads/'.$unidadDireccion->imagen_direccion), 'Sin Imagen', array('id'=>'imagen_icono', 'class' =>'img-thumbnail','width'=>'260'))
                                    }}
                            ...
                            <div class="col-md-4">
                                ...
                                @else
                                    {{
                                          Html::image(asset('storage/uploads/'.$unidadDireccion->organigrama), 'Sin Imagen', array('id'=>'organigrama', 'class' =>'img-thumbnail','width'=>'600'))
                                    }}
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        var latitud = {{$unidadDireccion->latitud}};
        var longitud = {{$unidadDireccion->longitud}};
        var zoom = {{$zoom ?? 18}};
        ...
        function eliminarImagenBanner(imu_id,und_id){
            ...
            if(cantIma>=2) {
                loaderR.showPleaseWait();
                $.ajax({
                    url: '{{url("sisadmin/unidaddireccion/_eliminarimagen_unidad")}}',
                    data: {
                        imu_id: imu_id,
                        und_id: und_id
                    },
