...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @else
                <h3 align="center">Editar Unidad Direccion :{{$unidad->nombre}}</h3>
            @endif
            @if ($unidadDireccion->und_id == 0)
            ...
            @endif
            <br>
            <form id="formulario" autocomplete="off" method="POST" enctype="multipart/form-data" action="{{ url('sisadmin/unidaddireccion/storeeditar') }}">
