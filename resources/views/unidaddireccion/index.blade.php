...
@section('content')
    ...
    <div class="row justify-content-center">
        <h3 align="center">Lista de Direcciones</h3>
        <div class="col-md-12">
            <div class="col-md-12">


                @if (verificarAcceso(81))
                    <a href="{{ url('sisadmin/unidaddireccion/create') }}" class="btn btn-primary btn-sm" id="btnNuevo"><i class="fa fa-plus"></i> Agregar</a>
                @else
                    ...
                    <table class="table table-hover table-responsive-xl table-sm" id="tablaContenido">
                        ...
                        @foreach ($lista as $key => $item)
                            <tr>
                                ...
                                <td>
                                    @if (verificarAcceso(82))
                                        @if ($item->estado == 'AC')
                                            <a href="{{ url('sisadmin/unidaddireccion/edit/'.$item->und_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                        @endif
                                        @if ($item->estado != 'AC')
                                        @endif
                                    @else
