            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                        ...
                        <!-- Mediateka -->
                        <li><a class="dropdown-item @if(!verificarAcceso(13)) disabled @endif" href="{{url('sisadmin/videosonido/'.Auth::user()->und_id)}}">Mediateka</a></li>

                        <!-- Semanario -->
                        <li><a class="dropdown-item" href="{{ route('con-semanarios.index') }}">Semanario digital</a></li>

                        <!-- Transmisiones -->
                        <li><a class="dropdown-item" href="{{ route('transmisiones.index') }}">Transmisión TV en linea</a></li>

                        <!-- Gobernación TV -->
                        <li><a class="dropdown-item" href="{{ route('gobernaciontv.index') }}">Gobernación TV</a></li>

                        <!-- Gobernación TV -->
                        <li><a class="dropdown-item" href="{{ route('radiotv.index') }}">Radio online</a></li>


                        <!-- Jaku -->
                        <li><a class="dropdown-item" href="{{ route('gestionjakutv.index') }}">JAKU</a></li>
                        ...
                        <!-- 
                        <li><a class="dropdown-item @if(!verificarAcceso(53)) disabled @endif text-success" href="{{url('sisadmin/serviciopublico/'.Auth::user()->und_id.'/lista')}}">Secretarias</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink3">
                        ...
                        <!-- Auditoria -->
                        <li><a class="dropdown-item @if(!verificarAcceso(38)) disabled @endif" href="{{url('sisadmin/documento/'.Auth::user()->und_id.'/lista')}}">Auditoria</a></li>
                        <!-- Gaceta -->
                        <li><a class="dropdown-item @if(!verificarAcceso(33)) disabled @endif" href="{{url('sisadmin/documentolegal/'.Auth::user()->und_id.'/lista')}}">Gaceta</a></li>
