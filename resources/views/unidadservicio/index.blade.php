...
@section('content')
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                @if (verificarAcceso(91))
                <a href="{{ url('sisadmin/unidadservicio/create') }}" class="btn btn-primary btn-sm" id="btnNuevo"><i class="fa fa-plus"></i> Agregar</a>
                @else
                    ...
                    <table class="table table-hover table-responsive-xl table-sm" id="tablaContenido">
                        ...
                        @foreach ($lista as $key => $item)
                            <tr>
                                ...
                                <td>
                                    @if (verificarAcceso(92))
                                        @if ($item->estado == 'AC')
                                            <a href="{{ url('sisadmin/unidadservicio/edit/'.$item->und_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                        @endif
                                        @if ($item->estado != 'AC')
                                        @endif
                                    @else
            ...
            $.confirm({
                ...
                buttons: {
                    SI: {
                        ...
                        action: function(){
                            $.ajax({
                                url : '{{url("sisadmin/unidadunidad/_modificarEstado")}}',
                                data : {
                                    und_id:und_id,
                                    texto:texto
                                },
                                ...
                                success : function(resp) {
                                    ...
                                    if(resp.res == true){
                                        ...
                                        toastr.error('Ocurrio un error al '+texto+' la unidad : '+nombre+'','');
                                    }
                                },
