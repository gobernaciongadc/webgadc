...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @else
                <h3 align="center">Editar {{$unidad->nombre}}</h3>
            @endif
            @if ($unidadServicio->und_id == 0)
            ...
            @endif
            <br>
            <form id="formulario" autocomplete="off" method="POST" enctype="multipart/form-data" action="{{ url('sisadmin/unidadservicio/storeeditar') }}">
                        ...
                        <div class="col-md-12 row"><br><br>
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        {{
                                             Form::select('und_padre_id',$listaComboUnidades, $unidadServicio->und_padre_id,  ['class' => 'form-control form-control-sm','id' => 'und_padre_id','style' => 'width:100%;' ,'name'=>'und_padre_id','require'=>'require'])
                                        }}
                                    </div>
                                    @error('und_padre_id')
                                    <p class="form-text text-danger">{{ $message }}</p>
