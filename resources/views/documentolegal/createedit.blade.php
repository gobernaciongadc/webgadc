    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form class="form-horizontal" id="formulario" autocomplete="off" method="POST" enctype="multipart/form-data" action="{{ url('sisadmin/documentolegal/store') }}">
                ...
                @if ( $documentoLegal->dol_id == 0)
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label text-right">Fecha aprobacion*:</label>
                        <div class="col-md-4">
                ...
                @if ( $documentoLegal->dol_id == 0)
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label text-right">Fecha promulgacion*:</label>
                        <div class="col-md-4">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label text-right" >Numero Documento*:</label>
                    <div class="col-md-4">
