    ...
    public  function store(Request $request)
    {
        ...
        if ($request->dol_id == 0) {
            ...
            if ($request->hasFile('anexo')) {
                $extensionAnexo = $request->anexo->extension();
                $nombreAlternoAnexo = time() . '' . uniqid();
                $path = $request->anexo->storeAs('public/uploads/', $nombreAlternoAnexo . '.' . $extensionAnexo);
                $data['anexo'] = $nombreAlternoAnexo . '.' . $extensionAnexo;
            }
