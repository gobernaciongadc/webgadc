...
class UnidadRepository
{
    ...
    public function save($data): ?Unidad
    {
        ...
        if (isset($data['telefonos'])) {
            $unidad->telefonos = $data['telefonos'];
        } else {
            $unidad->telefonos = null;
        }
        if (isset($data['email'])) {
            $unidad->email = $data['email'];
        } else {
            $unidad->email = null;
        }
    ...
    public function update($data): ?Unidad
    {
        ...
        if (isset($data['link_facebook'])) {
            $unidad->link_facebook = $data['link_facebook'];
        } else {
            $unidad->link_facebook = null;
        }
        if (isset($data['link_twiter'])) {
            $unidad->link_twiter = $data['link_twiter'];
        } else {
            $unidad->link_twiter = null;
        }
        if (isset($data['link_instagram'])) {
            $unidad->link_instagram = $data['link_instagram'];
        } else {
            $unidad->link_instagram = null;
        }
        if (isset($data['link_youtube'])) {
            $unidad->link_youtube = $data['link_youtube'];
        } else {
            $unidad->link_youtube = null;
        }
        $unidad->estado = $data['estado'];
        if (isset($data['longitud'])) {
            $unidad->longitud = $data['longitud'];
        } else {
            $unidad->longitud = null;
        }
        if (isset($data['latitud'])) {
            $unidad->latitud = $data['latitud'];
        } else {
            $unidad->latitud = null;
        }
    ...
    {
        return $this->unidad->where([])->whereHas('tipoUnidad', function ($query) use ($tipoUnidad) {
