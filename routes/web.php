...
Route::group(['prefix' => 'sisadmin/'], function() {
    ...
    Route::post('sendVerification', function (){return redirect('/');})->name('register.sendverification');
    Route::get('sendVerification/{token}', function (){return redirect('/');})->name('register.validateverification');

    Route::get('password/reset', function (){return redirect('/');})->name('password.request');
    Route::post('password/email', function (){return redirect('/');})->name('password.email');
    Route::get('password/reset/{token}', function (){return redirect('/');})->name('password.reset');
    Route::post('password/reset', function (){return redirect('/');})->name('password.update');
